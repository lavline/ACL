...
#define PROTO_LAYER 3  //  if this att is enabled, this refers to the layer
...
#define DPORT_SIZE 1024
#define DPORT_END_CELL 1023
#define DPORT_WIDTH 128
#define DPORT_OVERLAP 64
#define DPORT_SLICE 32
#define DPORT_WIDTH_BIT 7
#define DPORT_OVERLAP_BIT 6
